...
public class MainTestArrayStorage {
    ...
    public static void main(String[] args) {
        Resume resume1 = new Resume("uuid1", null);
        Resume resume2 = new Resume("uuid2", null);
        Resume resume3 = new Resume("uuid3", null);
        ...
        Resume updateR3 = new Resume("uuid3", null);
        ARRAY_STORAGE.update(resume3);

        Resume dummy = new Resume("uuid4", null);
